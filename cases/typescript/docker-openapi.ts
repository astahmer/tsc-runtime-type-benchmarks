export namespace Schemas {
  ...
  export type DeviceMapping = Partial<{
    PathOnHost: string;
  ...
  export type HealthcheckResult = Partial<{
    Start: string;
    End: string;
    ExitCode: number;
    Output: string;
  ...
  export type ClusterVolumeSpec = Partial<{
    ...
    AccessMode: Partial<{
      ...
      AccessibilityRequirements: Partial<{
  ...
  export type VolumeListResponse = Partial<{
  ...
  export type PluginPrivilege = Partial<{
    Name: string;
    Description: string;
    Value: Array<string>;
  }>;
  ...
  export type NodeStatus = Partial<{
    State: NodeState;
    Message: string;
    Addr: string;
  }>;
  export type Reachability = "unknown" | "unreachable" | "reachable";
  export type ManagerStatus = Partial<{
    Leader: boolean;
  ...
  export type TaskSpec = Partial<{
    ...
    ContainerSpec: Partial<{
      ...
      Privileges: Partial<{
        ...
        AppArmor: Partial<{ Mode: "default" | "disabled" }>;
    ...
    Placement: Partial<{
      ...
      Preferences: Array<
        Partial<{ Spread: Partial<{ SpreadDescriptor: string }> }>
      >;
      MaxReplicas: number;
  ...
  export type TaskState =
    ...
    | "remove"
    | "orphaned";
  export type ContainerStatus = Partial<{
    ContainerID: string;
    PID: number;
    ExitCode: number;
  }>;
  ...
  export type PortStatus = Partial<{ Ports: Array<EndpointPortConfig> }>;
  export type TaskStatus = Partial<{
    Timestamp: string;
    State: TaskState;
    Message: string;
    Err: string;
  ...
  export type EndpointSpec = Partial<{
    Mode: "vip" | "dnsrr";
  ...
  export type ImageDeleteResponseItem = Partial<{
    Untagged: string;
    Deleted: string;
  }>;
  export type ServiceCreateResponse = Partial<{
    ID: string;
  ...
  export type ContainerWaitResponse = {
    StatusCode: number;
    Error?: ContainerWaitExitError | undefined;
  };
  export type SystemVersion = Partial<{
    ...
    Components: Array<{
      Name: string;
      Version: string;
      Details?: Partial<{}> | null | undefined;
    }>;
    Version: string;
    ApiVersion: string;
  ...
  export type OCIDescriptor = Partial<{
    mediaType: string;
    digest: string;
    size: number;
  }>;
...
export namespace Endpoints {
    ...
    parameters: {
      ...
      body: Schemas.ContainerConfig &
        Partial<{
          ...
          NetworkingConfig: Schemas.NetworkingConfig;
        }>;
    };
  ...
  export type post_ContainerUpdate = {
    ...
    parameters: {
      ...
      body: Schemas.Resources &
        Partial<{ RestartPolicy: Schemas.RestartPolicy }>;
    };
  ...
  export type post_ImagePrune = {
    ...
    response: Partial<{
      ImagesDeleted: Array<Schemas.ImageDeleteResponseItem>;
      SpaceReclaimed: number;
    }>;
  };
  ...
  export type post_ServiceCreate = {
    ...
    response: Schemas.ServiceCreateResponse;
  };
