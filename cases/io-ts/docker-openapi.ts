...
export const Mount = t.type({
  ...
  BindOptions: t.union([
    ...
    t.type({
      ...
      ReadOnlyNonRecursive: t.union([t.undefined, t.boolean]),
      ReadOnlyForceRecursive: t.union([t.undefined, t.boolean]),
    }),
  ]),
  VolumeOptions: t.union([
    ...
    t.type({
      ...
      Subpath: t.union([t.undefined, t.string]),
    }),
  ]),
...
export const HealthConfig = t.type({
  ...
  StartInterval: t.union([t.undefined, t.number]),
});
...
export const HostConfig = t.intersection([
  ...
  t.type({
    ...
    CgroupnsMode: t.union([
      t.undefined,
      t.union([t.literal("private"), t.literal("host")]),
    ]),
...
export const EndpointSettings = t.type({
  ...
  DNSNames: t.union([t.undefined, t.array(t.string)]),
});
...
export const NetworkSettings = t.type({
  ...
  SecondaryIPAddresses: t.union([
    t.undefined,
    t.union([t.array(Address), t.null]),
  ]),
  SecondaryIPv6Addresses: t.union([
    t.undefined,
    t.union([t.array(Address), t.null]),
  ]),
  EndpointID: t.union([t.undefined, t.string]),
...
export const ImageInspect = t.type({
  ...
  Created: t.union([t.undefined, t.union([t.string, t.null])]),
  ...
  AccessMode: t.union([
    ...
    t.type({
      ...
      Availability: t.union([
        t.undefined,
        t.union([t.literal("active"), t.literal("pause"), t.literal("drain")]),
      ]),
    }),
  ]),
});
  ...
  Config: t.type({
    ...
    Interface: t.type({
      ...
      ProtocolScheme: t.union([
        ...
        t.union([
          t.literal(""),
          t.literal("moby.plugins.http/v1"),
          t.undefined,
        ]),
      ]),
    }),
...
export const NodeSpec = t.type({
  ...
  Role: t.union([
    t.undefined,
    t.union([t.literal("worker"), t.literal("manager")]),
  ]),
  Availability: t.union([
    t.undefined,
    t.union([t.literal("active"), t.literal("pause"), t.literal("drain")]),
...
export const Reachability = t.union([
  t.literal("unknown"),
...
export const TaskSpec = t.type({
          ...
          Seccomp: t.union([
            ...
            t.type({
              Mode: t.union([
                ...
                t.union([
                  t.literal("default"),
                  t.literal("unconfined"),
                  t.literal("custom"),
                ]),
              ]),
              Profile: t.union([t.undefined, t.string]),
            }),
          ]),
          AppArmor: t.union([
            t.undefined,
            t.type({
              Mode: t.union([
                t.undefined,
                t.union([t.literal("default"), t.literal("disabled")]),
              ]),
            }),
          ]),
          NoNewPrivileges: t.union([t.undefined, t.boolean]),
        }),
      ]),
      TTY: t.union([t.undefined, t.boolean]),
      OpenStdin: t.union([t.undefined, t.boolean]),
  ...
  RestartPolicy: t.union([
    ...
    t.type({
      Condition: t.union([
        t.undefined,
        t.union([t.literal("none"), t.literal("on-failure"), t.literal("any")]),
      ]),
...
export type ContainerStatus = t.TypeOf<typeof ContainerStatus>;
export const ContainerStatus = t.type({
  ContainerID: t.union([t.undefined, t.string]),
...
export const EndpointPortConfig = t.type({
  ...
  Protocol: t.union([
    t.undefined,
    t.union([t.literal("tcp"), t.literal("udp"), t.literal("sctp")]),
  ]),
  TargetPort: t.union([t.undefined, t.number]),
  PublishedPort: t.union([t.undefined, t.number]),
  PublishMode: t.union([
    t.undefined,
    t.union([t.literal("ingress"), t.literal("host")]),
  ]),
});

export type PortStatus = t.TypeOf<typeof PortStatus>;
export const PortStatus = t.type({
  Ports: t.union([t.undefined, t.array(EndpointPortConfig)]),
});

export type TaskStatus = t.TypeOf<typeof TaskStatus>;
export const TaskStatus = t.type({
  Timestamp: t.union([t.undefined, t.string]),
  State: t.union([t.undefined, TaskState]),
  Message: t.union([t.undefined, t.string]),
  Err: t.union([t.undefined, t.string]),
  ContainerStatus: t.union([t.undefined, ContainerStatus]),
  PortStatus: t.union([t.undefined, PortStatus]),
});
...
export const Task = t.type({
  ...
  Status: t.union([t.undefined, TaskStatus]),
...
export const ServiceSpec = t.type({
  ...
  UpdateConfig: t.union([
    ...
    t.type({
      ...
      Order: t.union([
        t.undefined,
        t.union([t.literal("stop-first"), t.literal("start-first")]),
      ]),
    }),
  ]),
  RollbackConfig: t.union([
    ...
    t.type({
      ...
      FailureAction: t.union([
        t.undefined,
        t.union([t.literal("continue"), t.literal("pause")]),
      ]),
      Monitor: t.union([t.undefined, t.number]),
      MaxFailureRatio: t.union([t.undefined, t.number]),
      Order: t.union([
...
export type ServiceCreateResponse = t.TypeOf<typeof ServiceCreateResponse>;
export const ServiceCreateResponse = t.type({
  ID: t.union([t.undefined, t.string]),
  Warnings: t.union([t.undefined, t.union([t.array(t.string), t.null])]),
});
  ...
  Components: t.union([
    ...
    t.array(
      t.type({
        ...
        Details: t.union([
          t.undefined,
          t.union([t.type({}), t.null, t.undefined]),
        ]),
      })
    ),
  ]),
...
export const RegistryServiceConfig = t.union([
  t.type({
    AllowNondistributableArtifactsCIDRs: t.union([
      t.undefined,
      t.array(t.string),
    ]),
    AllowNondistributableArtifactsHostnames: t.union([
      t.undefined,
      t.array(t.string),
    ]),
...
export const Runtime = t.type({
  ...
  status: t.union([t.undefined, t.union([t.unknown, t.null])]),
});
...
export const SystemInfo = t.type({
  ...
  CgroupDriver: t.union([
    t.undefined,
    t.union([t.literal("cgroupfs"), t.literal("systemd"), t.literal("none")]),
  ]),
  CgroupVersion: t.union([
    t.undefined,
  ...
  Isolation: t.union([
    t.undefined,
    t.union([t.literal("default"), t.literal("hyperv"), t.literal("process")]),
  ]),
  ...
  Warnings: t.union([t.undefined, t.array(t.string)]),
  CDISpecDirs: t.union([t.undefined, t.array(t.string)]),
});
...
export const EventMessage = t.type({
  ...
  scope: t.union([
    t.undefined,
    t.union([t.literal("local"), t.literal("swarm")]),
  ]),
...
export type get_ContainerAttachWebsocket = t.TypeOf<
  typeof get_ContainerAttachWebsocket
>;
...
export type head_ContainerArchiveInfo = t.TypeOf<
  typeof head_ContainerArchiveInfo
>;
