  ...
  Type.Object({
    ...
    BindOptions: Type.Partial(
      Type.Object({
        ...
        ReadOnlyNonRecursive: Type.Boolean(),
        ReadOnlyForceRecursive: Type.Boolean(),
      })
    ),
...
export const EndpointSettings = Type.Partial(
  Type.Object({
    ...
    DNSNames: Type.Array(Type.String()),
  })
);
...
export const ChangeType = Type.Union([
  Type.Literal(0),
  Type.Literal(1),
  Type.Literal(2),
]);
...
export const ImageInspect = Type.Partial(
  Type.Object({
    ...
    Parent: Type.String(),
    Comment: Type.String(),
    Created: Type.Union([Type.String(), Type.Null()]),
  ...
  Config: Type.Object({
    ...
    Interface: Type.Object({
      ...
      ProtocolScheme: Type.Optional(
        Type.Union([
          Type.Literal(""),
          Type.Literal("moby.plugins.http/v1"),
          Type.Undefined(),
        ])
      ),
    }),
      ...
      Type.Object({
        ...
        Privileges: Type.Partial(
          Type.Object({
            ...
            Seccomp: Type.Partial(
              Type.Object({
                Mode: Type.Union([
                  Type.Literal("default"),
                  Type.Literal("unconfined"),
                  Type.Literal("custom"),
                ]),
                Profile: Type.String(),
              })
            ),
            AppArmor: Type.Partial(
              Type.Object({
                Mode: Type.Union([
                  Type.Literal("default"),
...
export type ContainerStatus = Static<typeof ContainerStatus>;
export const ContainerStatus = Type.Partial(
  Type.Object({
    ContainerID: Type.String(),
    PID: Type.Number(),
    ExitCode: Type.Number(),
...
export type PortStatus = Static<typeof PortStatus>;
export const PortStatus = Type.Partial(
  Type.Object({
...
export const TaskStatus = Type.Partial(
  Type.Object({
  ...
  Type.Object({
    ...
    UpdateConfig: Type.Partial(
      Type.Object({
        ...
        Order: Type.Union([
          Type.Literal("stop-first"),
          Type.Literal("start-first"),
        ]),
      })
    ),
...
export type ServiceCreateResponse = Static<typeof ServiceCreateResponse>;
export const ServiceCreateResponse = Type.Partial(
  Type.Object({
    ID: Type.String(),
    Warnings: Type.Union([Type.Array(Type.String()), Type.Null()]),
  })
);
...
export const Runtime = Type.Partial(
  Type.Object({
    ...
    status: Type.Union([Type.Unknown(), Type.Null()]),
  })
);
...
export const SystemInfo = Type.Partial(
  Type.Object({
    ...
    CgroupDriver: Type.Union([
      Type.Literal("cgroupfs"),
    ...
    Warnings: Type.Array(Type.String()),
    CDISpecDirs: Type.Array(Type.String()),
  })
);
