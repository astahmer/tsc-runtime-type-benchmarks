  ...
  BindOptions: y
    .object({
      Propagation: y
        ...
        .oneOf([
          y
            .mixed((value): value is "private" => value === "private")
            .required(),
          y
            .mixed((value): value is "rprivate" => value === "rprivate")
            .required(),
          y.mixed((value): value is "shared" => value === "shared").required(),
          y
            .mixed((value): value is "rshared" => value === "rshared")
            .required(),
      ...
      ReadOnlyNonRecursive: y.boolean().required().optional(),
      ReadOnlyForceRecursive: y.boolean().required().optional(),
    })
    .optional(),
  VolumeOptions: y
    .object({
      ...
      DriverConfig: y
        ...
        .optional(),
      Subpath: y.string().required().optional(),
    })
    .optional(),
  TmpfsOptions: y
    .object({
...
export const RestartPolicy = y.object({
  Name: y
    ...
    .oneOf([
      ...
      y
        .mixed((value): value is "unless-stopped" => value === "unless-stopped")
        .required(),
      y
        .mixed((value): value is "on-failure" => value === "on-failure")
        .required(),
    ])
    .required()
    .optional(),
...
export const HealthConfig = y.object({
  ...
  StartInterval: y.number().required().optional(),
});
    ...
    y.object({
      Status: y
        ...
        .oneOf([
          ...
          y
            .mixed((value): value is "starting" => value === "starting")
            .required(),
          y
            .mixed((value): value is "healthy" => value === "healthy")
            .required(),
          y
            .mixed((value): value is "unhealthy" => value === "unhealthy")
            .required(),
        ])
        .required()
        .optional(),
  ...
  LogConfig: y
    .object({
      Type: y
        ...
        .oneOf([
          y
            .mixed((value): value is "json-file" => value === "json-file")
            .required(),
          y.mixed((value): value is "syslog" => value === "syslog").required(),
          y
            .mixed((value): value is "journald" => value === "journald")
            .required(),
          y.mixed((value): value is "gelf" => value === "gelf").required(),
          y
            .mixed((value): value is "fluentd" => value === "fluentd")
            .required(),
          y
            .mixed((value): value is "awslogs" => value === "awslogs")
            .required(),
          y.mixed((value): value is "splunk" => value === "splunk").required(),
          y
            .mixed((value): value is "etwlogs" => value === "etwlogs")
            .required(),
          y.mixed((value): value is "none" => value === "none").required(),
        ])
        .required()
...
export const EndpointSettings = y.object({
  ...
  DriverOpts: y
    ...
    .required()
    .optional(),
  DNSNames: y.array(y.string().required()).optional(),
});
    ...
    .object({
      ...
      Sharing: y
        ...
        .oneOf([
          y.mixed((value): value is "none" => value === "none").required(),
          y
            .mixed((value): value is "readonly" => value === "readonly")
            .required(),
          y
            .mixed((value): value is "onewriter" => value === "onewriter")
            .required(),
      ...
      y.object({
        ...
        State: y
          ...
          .oneOf([
            y
              .mixed(
                (value): value is "pending-publish" =>
                  value === "pending-publish"
              )
              .required(),
            y
              .mixed((value): value is "published" => value === "published")
              .required(),
            y
              .mixed(
                (value): value is "pending-node-unpublish" =>
                  value === "pending-node-unpublish"
              )
              .required(),
            y
              .mixed(
                (value): value is "pending-controller-unpublish" =>
                  value === "pending-controller-unpublish"
              )
              .required(),
          ])
          .required()
...
export const BuildCache = y.object({
  ...
  Type: y
    ...
    .oneOf([
      ...
      y
        .mixed((value): value is "source.local" => value === "source.local")
        .required(),
      y
        .mixed(
          (value): value is "source.git.checkout" =>
            value === "source.git.checkout"
        )
        .required(),
      y
        .mixed(
          (value): value is "exec.cachemount" => value === "exec.cachemount"
        )
        .required(),
    ...
    Interface: y.object({
      ...
      ProtocolScheme: y
        ...
        .oneOf([
          ...
          y
            .mixed(
              (value): value is "moby.plugins.http/v1" =>
...
export const NodeState = y
  ...
  .oneOf([
    ...
    y
      .mixed((value): value is "disconnected" => value === "disconnected")
      .required(),
  ])
  .required();
...
export const Reachability = y
  ...
  .oneOf([
    y.mixed((value): value is "unknown" => value === "unknown").required(),
    y
      .mixed((value): value is "unreachable" => value === "unreachable")
      .required(),
...
export type NetworkAttachmentConfig = y.InferType<
  typeof NetworkAttachmentConfig
>;
          ...
          Seccomp: y
            .object({
              Mode: y
                ...
                .oneOf([
                  y
                    .mixed((value): value is "default" => value === "default")
                    .required(),
                  y
                    .mixed(
                      (value): value is "unconfined" => value === "unconfined"
                    )
                    .required(),
                  y
                    .mixed((value): value is "custom" => value === "custom")
                    .required(),
                ])
                .required()
                .optional(),
              Profile: y.string().required().optional(),
            })
            .optional(),
          AppArmor: y
            .object({
              Mode: y
                ...
                .oneOf([
                  y
                    ...
                    .required(),
                  y
                    .mixed((value): value is "disabled" => value === "disabled")
                    .required(),
                ])
                .required()
                .optional(),
            ...
            .optional(),
          NoNewPrivileges: y.boolean().required().optional(),
        })
        .optional(),
      TTY: y.boolean().required().optional(),
      OpenStdin: y.boolean().required().optional(),
      ...
      Isolation: y
        ...
        .oneOf([
          y
            ...
            .required(),
          y
            .mixed((value): value is "process" => value === "process")
            .required(),
          y.mixed((value): value is "hyperv" => value === "hyperv").required(),
        ])
        .required()
...
export type ContainerStatus = y.InferType<typeof ContainerStatus>;
export const ContainerStatus = y.object({
  ContainerID: y.string().required().optional(),
...
export type PortStatus = y.InferType<typeof PortStatus>;
export const PortStatus = y.object({
  Ports: y.array(EndpointPortConfig).optional(),
});

export type TaskStatus = y.InferType<typeof TaskStatus>;
export const TaskStatus = y.object({
  ...
  PortStatus: PortStatus.optional(),
});
  ...
  UpdateConfig: y
    .object({
      ...
      FailureAction: y
        ...
        .oneOf([
          y
            .mixed((value): value is "continue" => value === "continue")
            .required(),
          y.mixed((value): value is "pause" => value === "pause").required(),
          y
            .mixed((value): value is "rollback" => value === "rollback")
            .required(),
        ])
        .required()
        .optional(),
      ...
      Order: y
        ...
        .oneOf([
          y
            .mixed((value): value is "stop-first" => value === "stop-first")
            .required(),
          y
            .mixed((value): value is "start-first" => value === "start-first")
            .required(),
        ])
        .required()
        .optional(),
  ...
  UpdateStatus: y
    .object({
      State: y
        ...
        .oneOf([
          y
            .mixed((value): value is "updating" => value === "updating")
            .required(),
          y.mixed((value): value is "paused" => value === "paused").required(),
          y
            .mixed((value): value is "completed" => value === "completed")
            .required(),
        ])
        .required()
        .optional(),
...
export type ImageDeleteResponseItem = y.InferType<
  typeof ImageDeleteResponseItem
>;
...
export type ServiceCreateResponse = y.InferType<typeof ServiceCreateResponse>;
export const ServiceCreateResponse = y.object({
  ID: y.string().required().optional(),
  Warnings: y
    .mixed()
    .oneOf([
  ...
  .oneOf([
    y.object({
      Status: y
        ...
        .oneOf([
          y
            .mixed((value): value is "created" => value === "created")
            .required(),
          y
            .mixed((value): value is "running" => value === "running")
            .required(),
          y.mixed((value): value is "paused" => value === "paused").required(),
          y
            .mixed((value): value is "restarting" => value === "restarting")
            .required(),
          y
            .mixed((value): value is "removing" => value === "removing")
            .required(),
...
export type ContainerCreateResponse = y.InferType<
  typeof ContainerCreateResponse
>;
...
export const RegistryServiceConfig = y
  ...
  .oneOf([
    y.object({
      AllowNondistributableArtifactsCIDRs: y
        .array(y.string().required())
        .optional(),
      AllowNondistributableArtifactsHostnames: y
        .array(y.string().required())
        .optional(),
...
export const SystemInfo = y.object({
  ...
  DefaultAddressPools: y
    ...
    .optional(),
  Warnings: y.array(y.string().required()).optional(),
  CDISpecDirs: y.array(y.string().required()).optional(),
});
...
export const EventMessage = y.object({
  Type: y
    ...
    .oneOf([
      ...
      y
        .mixed((value): value is "container" => value === "container")
        .required(),
...
export const get_ContainerList = {
  ...
  path: y
    .mixed((value): value is "/containers/json" => value === "/containers/json")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerCreate = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/create" => value === "/containers/create"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ContainerInspect = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/json" =>
        value === "/containers/{id}/json"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ContainerTop = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/top" =>
        value === "/containers/{id}/top"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ContainerLogs = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/logs" =>
        value === "/containers/{id}/logs"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ContainerChanges = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/changes" =>
        value === "/containers/{id}/changes"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const get_ContainerExport = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/export" =>
        value === "/containers/{id}/export"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const get_ContainerStats = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/stats" =>
        value === "/containers/{id}/stats"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerResize = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/resize" =>
        value === "/containers/{id}/resize"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerStart = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/start" =>
...
export const post_ContainerStop = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/stop" =>
        value === "/containers/{id}/stop"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerRestart = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/restart" =>
        value === "/containers/{id}/restart"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerKill = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/kill" =>
        value === "/containers/{id}/kill"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerUpdate = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/update" =>
        value === "/containers/{id}/update"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_ContainerRename = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/rename" =>
        value === "/containers/{id}/rename"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerPause = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/pause" =>
        value === "/containers/{id}/pause"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_ContainerUnpause = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/unpause" =>
        value === "/containers/{id}/unpause"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_ContainerAttach = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/attach" =>
...
export const get_ContainerAttachWebsocket = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/attach/ws" =>
        value === "/containers/{id}/attach/ws"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerWait = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/wait" =>
        value === "/containers/{id}/wait"
    )
    .required(),
  parameters: y.object({
    query: y.object({
      condition: y
        ...
        .oneOf([
          y
            .mixed((value): value is "not-running" => value === "not-running")
            .required(),
          y
            .mixed((value): value is "next-exit" => value === "next-exit")
            .required(),
          y
            .mixed((value): value is "removed" => value === "removed")
            .required(),
        ])
        .required()
        .optional(),
...
export const delete_ContainerDelete = {
  ...
  path: y
    .mixed((value): value is "/containers/{id}" => value === "/containers/{id}")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ContainerArchive = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/archive" =>
        value === "/containers/{id}/archive"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerPrune = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/prune" => value === "/containers/prune"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ImageList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/images/json" => value === "/images/json")
    .required(),
  parameters: y.object({
    query: y.object({
      all: y.boolean().required().optional(),
...
export const post_ImageBuild = {
  ...
  parameters: y.object({
    ...
    header: y.object({
      "Content-type": y
        .mixed(
          (value): value is "application/x-tar" => value === "application/x-tar"
        )
        .required()
        .optional(),
...
export const post_BuildPrune = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/build/prune" => value === "/build/prune")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ImageCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/images/create" => value === "/images/create")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ImageInspect = {
  ...
  path: y
    .mixed(
      (value): value is "/images/{name}/json" => value === "/images/{name}/json"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const get_ImageHistory = {
  ...
  path: y
    .mixed(
      (value): value is "/images/{name}/history" =>
        value === "/images/{name}/history"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_ImagePush = {
  ...
  path: y
    .mixed(
      (value): value is "/images/{name}/push" => value === "/images/{name}/push"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ImageTag = {
  ...
  path: y
    .mixed(
      (value): value is "/images/{name}/tag" => value === "/images/{name}/tag"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const delete_ImageDelete = {
  method: y.mixed((value): value is "DELETE" => value === "DELETE").required(),
  path: y
    .mixed((value): value is "/images/{name}" => value === "/images/{name}")
    .required(),
  parameters: y.object({
    query: y.object({
      force: y.boolean().required().optional(),
...
export const get_ImageSearch = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/images/search" => value === "/images/search")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ImagePrune = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/images/prune" => value === "/images/prune")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const get_SystemVersion = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/version" => value === "/version")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
...
export const get_SystemDataUsage = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/system/df" => value === "/system/df")
    .required(),
  parameters: y.object({
    query: y.object({
      type: y
          ...
          y
            ...
            .oneOf([
              y
                ...
                .required(),
              y
                .mixed((value): value is "image" => value === "image")
                .required(),
              y
                .mixed((value): value is "volume" => value === "volume")
                .required(),
              y
                .mixed(
                  (value): value is "build-cache" => value === "build-cache"
                )
                .required(),
            ])
            .required()
...
export const get_ImageGet = {
  ...
  path: y
    .mixed(
      (value): value is "/images/{name}/get" => value === "/images/{name}/get"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const get_ImageGetAll = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/images/get" => value === "/images/get")
    .required(),
  parameters: y.object({
    query: y.object({
      names: y.array(y.string().required()).optional(),
...
export const post_ImageLoad = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/images/load" => value === "/images/load")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ContainerExec = {
  ...
  path: y
    .mixed(
      (value): value is "/containers/{id}/exec" =>
        value === "/containers/{id}/exec"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_ExecStart = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/exec/{id}/start" => value === "/exec/{id}/start")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const post_ExecResize = {
  ...
  path: y
    .mixed(
      (value): value is "/exec/{id}/resize" => value === "/exec/{id}/resize"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ExecInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/exec/{id}/json" => value === "/exec/{id}/json")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const get_VolumeList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/volumes" => value === "/volumes")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const post_VolumeCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/volumes/create" => value === "/volumes/create")
    .required(),
  parameters: y.object({
...
export const get_VolumeInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/volumes/{name}" => value === "/volumes/{name}")
    .required(),
  parameters: y.object({
    path: y.object({
      name: y.string().required(),
...
export const post_VolumePrune = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/volumes/prune" => value === "/volumes/prune")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const get_NetworkList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/networks" => value === "/networks")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const get_NetworkInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/networks/{id}" => value === "/networks/{id}")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_NetworkCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/networks/create" => value === "/networks/create")
    .required(),
  parameters: y.object({
    body: y.object({
      Name: y.string().required(),
...
export const post_NetworkConnect = {
  ...
  path: y
    .mixed(
      (value): value is "/networks/{id}/connect" =>
...
export const post_NetworkDisconnect = {
  ...
  path: y
    .mixed(
      (value): value is "/networks/{id}/disconnect" =>
        value === "/networks/{id}/disconnect"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_NetworkPrune = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/networks/prune" => value === "/networks/prune")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const get_PluginList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/plugins" => value === "/plugins")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const get_GetPluginPrivileges = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/privileges" => value === "/plugins/privileges"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_PluginPull = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/plugins/pull" => value === "/plugins/pull")
    .required(),
  parameters: y.object({
    query: y.object({
      remote: y.string().required(),
...
export const get_PluginInspect = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/json" =>
        value === "/plugins/{name}/json"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const delete_PluginDelete = {
  method: y.mixed((value): value is "DELETE" => value === "DELETE").required(),
  path: y
    .mixed((value): value is "/plugins/{name}" => value === "/plugins/{name}")
    .required(),
  parameters: y.object({
    query: y.object({
      force: y.boolean().required().optional(),
...
export const post_PluginEnable = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/enable" =>
        value === "/plugins/{name}/enable"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_PluginDisable = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/disable" =>
        value === "/plugins/{name}/disable"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_PluginUpgrade = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/upgrade" =>
        value === "/plugins/{name}/upgrade"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_PluginCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/plugins/create" => value === "/plugins/create")
    .required(),
  parameters: y.object({
    query: y.object({
      name: y.string().required(),
...
export const post_PluginPush = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/push" =>
        value === "/plugins/{name}/push"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_PluginSet = {
  ...
  path: y
    .mixed(
      (value): value is "/plugins/{name}/set" => value === "/plugins/{name}/set"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const get_NodeInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/nodes/{id}" => value === "/nodes/{id}")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const post_NodeUpdate = {
  ...
  path: y
    .mixed(
      (value): value is "/nodes/{id}/update" => value === "/nodes/{id}/update"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_SwarmInit = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/swarm/init" => value === "/swarm/init")
    .required(),
  parameters: y.object({
    body: y.object({
...
export const post_SwarmJoin = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/swarm/join" => value === "/swarm/join")
    .required(),
  parameters: y.object({
    body: y.object({
      ListenAddr: y.string().required().optional(),
...
export const post_SwarmLeave = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/swarm/leave" => value === "/swarm/leave")
    .required(),
  parameters: y.object({
    query: y.object({
      force: y.boolean().required().optional(),
...
export const post_SwarmUpdate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/swarm/update" => value === "/swarm/update")
    .required(),
  parameters: y.object({
    query: y.object({
      version: y.number().required(),
...
export const get_SwarmUnlockkey = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/swarm/unlockkey" => value === "/swarm/unlockkey")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: y.object({
...
export const post_SwarmUnlock = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/swarm/unlock" => value === "/swarm/unlock")
    .required(),
  parameters: y.object({
    body: y.object({
      UnlockKey: y.string().required().optional(),
...
export const get_ServiceList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/services" => value === "/services")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const post_ServiceCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/services/create" => value === "/services/create")
    .required(),
  parameters: y.object({
    header: y.object({
      "X-Registry-Auth": y.string().required().optional(),
...
export const get_ServiceInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/services/{id}" => value === "/services/{id}")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const post_ServiceUpdate = {
  ...
  path: y
    .mixed(
      (value): value is "/services/{id}/update" =>
        value === "/services/{id}/update"
    )
    .required(),
  parameters: y.object({
    query: y.object({
      ...
      registryAuthFrom: y
        ...
        .oneOf([
          ...
          y
            .mixed(
              (value): value is "previous-spec" => value === "previous-spec"
            )
            .required(),
        ])
        .required(),
...
export const get_ServiceLogs = {
  ...
  path: y
    .mixed(
      (value): value is "/services/{id}/logs" => value === "/services/{id}/logs"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_TaskInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/tasks/{id}" => value === "/tasks/{id}")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const get_TaskLogs = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/tasks/{id}/logs" => value === "/tasks/{id}/logs")
    .required(),
  parameters: y.object({
    query: y.object({
      details: y.boolean().required().optional(),
...
export const get_SecretList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/secrets" => value === "/secrets")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const post_SecretCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/secrets/create" => value === "/secrets/create")
    .required(),
  parameters: y.object({
    body: y.mixed(/* unsupported */),
  }),
...
export const get_SecretInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/secrets/{id}" => value === "/secrets/{id}")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const post_SecretUpdate = {
  ...
  path: y
    .mixed(
      (value): value is "/secrets/{id}/update" =>
        value === "/secrets/{id}/update"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_ConfigList = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/configs" => value === "/configs")
    .required(),
  parameters: y.object({
    query: y.object({
      filters: y.string().required().optional(),
...
export const post_ConfigCreate = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/configs/create" => value === "/configs/create")
    .required(),
  parameters: y.object({
    body: y.mixed(/* unsupported */),
  }),
...
export const get_ConfigInspect = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/configs/{id}" => value === "/configs/{id}")
    .required(),
  parameters: y.object({
    path: y.object({
      id: y.string().required(),
...
export const post_ConfigUpdate = {
  ...
  path: y
    .mixed(
      (value): value is "/configs/{id}/update" =>
        value === "/configs/{id}/update"
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_DistributionInspect = {
  ...
  path: y
    .mixed(
      (value): value is "/distribution/{name}/json" =>
        value === "/distribution/{name}/json"
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_Session = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/session" => value === "/session")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: y
    .mixed((value): value is any => true)
