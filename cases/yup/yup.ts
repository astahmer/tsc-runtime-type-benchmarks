...
export const Order = y.object({
  ...
  status: y
    ...
    .oneOf([
      ...
      y
        .mixed((value): value is "delivered" => value === "delivered")
        .required(),
    ])
    .required()
    .optional(),
...
export const post_UploadFile = {
  ...
  path: y
    .mixed(
      (value): value is "/pet/{petId}/uploadImage" =>
...
export const get_GetOrderById = {
  ...
  path: y
    .mixed(
      (value): value is "/store/order/{orderId}" =>
...
export const post_CreateUsersWithListInput = {
  ...
  path: y
    .mixed(
      (value): value is "/user/createWithList" =>
