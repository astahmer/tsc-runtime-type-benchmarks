...
export const HostConfig = z.intersection(
  ...
  z.object({
    ...
    Isolation: z
      .union([z.literal("default"), z.literal("process"), z.literal("hyperv")])
      .optional(),
  ...
  AccessMode: z
    .object({
      ...
      CapacityRange: z
        ...
        .optional(),
      Availability: z
        .union([z.literal("active"), z.literal("pause"), z.literal("drain")])
        .optional(),
    })
    .optional(),
});
  ...
  Config: z.object({
    ...
    Interface: z.object({
      ...
      ProtocolScheme: z
        .union([
          z.literal(""),
          z.literal("moby.plugins.http/v1"),
          z.undefined(),
        ])
        .optional(),
    }),
...
export const Reachability = z.union([
  z.literal("unknown"),
...
export const TaskSpec = z.object({
      ...
      Privileges: z
        .object({
          ...
          AppArmor: z
            .object({
              Mode: z
                .union([z.literal("default"), z.literal("disabled")])
                .optional(),
            })
            .optional(),
  ...
  RestartPolicy: z
    .object({
      Condition: z
        .union([z.literal("none"), z.literal("on-failure"), z.literal("any")])
        .optional(),
...
export const EndpointPortConfig = z.object({
  Name: z.string().optional(),
  Protocol: z
    .union([z.literal("tcp"), z.literal("udp"), z.literal("sctp")])
    .optional(),
...
export const ServiceSpec = z.object({
  ...
  UpdateConfig: z
    .object({
      ...
      Order: z
        .union([z.literal("stop-first"), z.literal("start-first")])
        .optional(),
    })
    .optional(),
  RollbackConfig: z
    .object({
      ...
      Delay: z.number().optional(),
      FailureAction: z
        .union([z.literal("continue"), z.literal("pause")])
        .optional(),
      Monitor: z.number().optional(),
      MaxFailureRatio: z.number().optional(),
      Order: z
...
export type ServiceCreateResponse = z.infer<typeof ServiceCreateResponse>;
export const ServiceCreateResponse = z.object({
  ID: z.string().optional(),
...
export const Runtime = z.object({
  ...
  status: z.union([z.unknown(), z.null()]).optional(),
});
...
export const SystemInfo = z.object({
  ...
  CgroupDriver: z
    .union([z.literal("cgroupfs"), z.literal("systemd"), z.literal("none")])
    .optional(),
  ...
  Isolation: z
    .union([z.literal("default"), z.literal("hyperv"), z.literal("process")])
    .optional(),
  ...
  DefaultAddressPools: z
    ...
    .optional(),
  Warnings: z.array(z.string()).optional(),
  CDISpecDirs: z.array(z.string()).optional(),
});
...
export const post_ServiceUpdate = {
  ...
  parameters: z.object({
    query: z.object({
      version: z.number(),
      registryAuthFrom: z.union([
        z.literal("spec"),
        z.literal("previous-spec"),
      ]),
      rollback: z.string(),
    }),
    path: z.object({
...
export class ApiClient {
  ...
  head<Path extends keyof HeadEndpoints, TEndpoint extends HeadEndpoints[Path]>(
    ...
    return this.fetcher("head", this.baseUrl + path, params[0]) as Promise<
      z.infer<TEndpoint["response"]>
    >;
  }
  // </ApiClient.head>
